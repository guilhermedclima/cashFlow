...
| # | Title | Status |
|---|---|---|
| [0001](0001-microsservicos.md) | Adopt microservices architecture | Accepted |
| [0002](0002-mensageria-assincrona.md) | Asynchronous communication via broker | Accepted |
...
| [0005](0005-cqrs-leve.md) | Lightweight CQRS (no Event Sourcing) | Accepted |
| [0006](0006-postgres-redis.md) | PostgreSQL + Redis | Accepted |
| [0007](0007-polly-resiliencia.md) | Resilience with Polly | Accepted |
| [0008](0008-idempotencia.md) | Idempotency in the consumer | Accepted |
...
2. Use the template at [`template.md`](template.md).
